...
public class RoundTwoFight extends JPanel implements ActionListener {
    ...
    protected void paintComponent(Graphics g) {
        ...
        ImageIcon monsterImageIcon = ImageAssets.load("HomeworkMonsterTwo.png");
    ...
    private void startBattleAction() {
        ...
        FightTwo roundTwoScene = new FightTwo(frame, chosenCharacters);
        frame.setContentPane(roundTwoScene);
        frame.revalidate();
        frame.repaint();
