...
public class NextBattlePanel extends JPanel implements ActionListener {
    ...
    // Kini nga constructor mag-andam sa transition screen padulong round 2.
    public NextBattlePanel(JFrame frame) {
        ...
        proceedButton = createButton("PROCEED ROUND 2");
    ...
    protected void paintComponent(Graphics g) {
        ...
        String text = "YOU DEFEATED THE HOMEWORK MONSTER!";
